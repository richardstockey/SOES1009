...
# load key functions and data from PaleogeographR

download.file(
  "https://raw.githubusercontent.com/richardstockey/PaleogeographR/main/data/ages.rda",
  destfile = "ages.rda",
  mode = "wb"
)
...
if(!file.exists("df_sum_gg.rda")) {
  download.file(
    "https://raw.githubusercontent.com/richardstockey/PaleogeographR/main/data/df_sum_gg.rda",
    destfile = "df_sum_gg.rda",
    mode = "wb"
  )
}
...
source("https://raw.githubusercontent.com/richardstockey/PaleogeographR/main/R/scotese.map.data.gg.R")
